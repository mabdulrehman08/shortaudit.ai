export function buildFallbackAnalysis(input) {
  ...
  return {
    hookStrength: {
      ...
      explanation: 'The concept is clear, but the first two seconds need a more specific pattern interrupt and open loop.',
    },
    retentionRisk: {
      ...
      explanation: isAggressive
        ...
        : 'Retention risk is manageable if the edit gets to proof quickly and avoids generic AI pacing.',
    },
    algorithmRisk: {
    ...
    platformSpecificAdvice: [
      `${platform} rewards native-feeling openings that create tension before explanation.`,
      ...
      'Avoid repeating the same stock b-roll rhythm across multiple uploads in a row.',
    ],
